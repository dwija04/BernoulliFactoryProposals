...
par(mfrow = c(2, 2))
plot(sensor_1.aux[, 1], sensor_1.aux[, 2], xlab = "x", ylab = "y", main = "Sensor 1")
plot(sensor_2.aux[, 1], sensor_2.aux[, 2], xlab = "x", ylab = "y", main = "Sensor 2")
plot(sensor_3.aux[, 1], sensor_3.aux[, 2], xlab = "x", ylab = "y", main = "Sensor 3")
plot(sensor_4.aux[, 1], sensor_4.aux[, 2], xlab = "x", ylab = "y", main = "Sensor 4")
dev.off()
